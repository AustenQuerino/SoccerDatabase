...
Revision ID: e8d4c55878cc
Revises: d1a29a9c9f90
Create Date: 2022-11-11 13:22:17.163875
...
revision = 'e8d4c55878cc'
down_revision = 'd1a29a9c9f90'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('home_stadium', sa.Integer(), nullable=False),
    ...
    sa.Column('committed_nation', sa.Integer(), nullable=False),
    sa.Column('club_team', sa.Integer(), nullable=False),
    sa.Column('national_team', sa.Integer(), nullable=False),
